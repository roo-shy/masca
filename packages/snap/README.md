...
<p align="center">
MascaClone enables everyone to build their <b>decentralized and self-sovereign identity by enhancing MetaMask with functionalities to manage DIDs, VCs, and VPs.</b> Any dapp can connect to it to access identity data, and dapp developers can already start with the integration!
</p>
